...
interface PermissionAssigneeOptionsResolver
{
    /**
     * Permission key => display label options for permission assignee selection.
     *
    ...
    /**
     * Display labels for users resolved from the given permission key.
     *
     * @return list<string>
     */

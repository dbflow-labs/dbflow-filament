...
final class DBFlowFilamentServiceProvider extends ServiceProvider
{
    public function register(): void
    {
        ...
        $this->app->singleton(WorkflowDelegationsQuery::class);
        $this->app->singleton(WorkflowActionExecutionsQuery::class);
        $this->app->singleton(WorkflowableShowUrlResolver::class);
        $this->app->singleton(RuntimeCapabilityGate::class);
        $this->app->singleton(RuntimeBadgePresenter::class);
        $this->app->singleton(AssignmentActorPresenter::class);
        $this->app->singleton(DueDatePresenter::class);
        $this->app->singleton(SafeMetadataPresenter::class);
        $this->app->singleton(TaskRuntimeSummaryPresenter::class);
        $this->app->singleton(WorkflowInstanceRuntimePresenter::class);
